# Usage:
# 1- Open VMD
# 2- From Tk console: "source visualise_nuclei.tcl"

# Frame number N in this VMD medley corresponds to line number (N+1)*4 in dfs_surf.dat

# Files needed
set sfile //storage/chem/mstscj/ALA/prismatic/small_system/alpha_ala/ICE/1/clusters/up/hbonds_results/STRUCTURE/em.gro
set tfile //storage/chem/mstscj/ALA/prismatic/small_system/alpha_ala/ICE/1/slice.xtc
# Colorfile
# Format: one line for each frame
# 	  in each line, n_atoms entries: 1 if ice, 0 if anything else
set cfile A.color 
