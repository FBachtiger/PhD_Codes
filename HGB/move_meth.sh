...
x=(3 4 5) # Residues which are methylated - needs to correspond to selective_HO5.sh						
CL=8	# total number of residues
...
#		#echo "end"
		...
		#echo "middle"	
		sed  -i -e "$(($new_O62+5 -22)),$(($new_O62+5)) s/AGAMX/OMEMX/g" plus.pdb  # middle residues line range is line with H93 i.e.$(($new_O62+5) -> to C1 (H93-23=line C1)
