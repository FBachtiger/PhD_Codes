#!/bin/bash
#converts doglycans pdb to a gromacs friendly pdb file
#main output file -> conf.pdb ->fully protonated HGB chain
#selective.sh ->glinks.sh to selectively deprotonate HGB

export cl=8                     #chain length ; number of agal sugar units in chain
...
rm -r -f test.pdb test1.pdb test2.pdb topol.top  posre.itp 
#use charmm37 JUL FF for this part -> main output is conf.pdb file which feeds into selective_HO5.sh
